...
# https://urban-university.pro/student/lesson/8818
...
values_list = [ 'list:', 'Mir', 'Trud']
values_dict = { 'a':'dict:', 'b':'Michail', 'c':'Sovietsky' }
...
def append_to_list(item, list_my=None):
    ...
    list_my.append(item)
    print(list_my)
append_to_list('Olga Smirnova')
append_to_list('Olga Smirnova', values_list)
